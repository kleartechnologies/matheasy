...
class CloudHistoryRepository extends CloudRepository {
  const CloudHistoryRepository(CloudStore store)
...
class CloudDailyChallengeRepository extends CloudRepository {
  const CloudDailyChallengeRepository(CloudStore store)
      : super(store, SyncDomain.dailyChallenge);
}
...
final Provider<Map<SyncDomain, CloudRepository>> cloudRepositoriesProvider =
  ...
  return {
    ...
    SyncDomain.dailyChallenge: CloudDailyChallengeRepository(store),
  };
});
