...
const OPERATION_LABELS: Record<string, string> = {
  ...
  // --- Radical + absolute-value equations (radical.ts) ---
  GIVEN: "The problem",
  ISOLATE_RADICAL: "Get the square root on its own",
  SQUARE_BOTH_SIDES: "Square both sides",
  RADICAL_CANCELS: "The square root cancels",
  EXPAND_SQUARE: "Expand the bracket",
  SIMPLIFY_RADICAL: "Simplify the square root",
  CANCEL_COMMON_FACTOR: "Cancel the common factor",
  ISOLATE_ABSOLUTE: "Get the modulus on its own",
  ABSOLUTE_CASES: "Two cases: inside positive, inside negative",
  ZERO_MODULUS: "Only zero has modulus zero",
  CASE_POSITIVE: "The positive case",
  CASE_NEGATIVE: "The negative case",
  COLLECT_TERMS: "Bring everything to one side",
  CANDIDATE_ROOTS: "These are only candidates so far",
  CHECK_KEEPS_ROOT: "Check it in the original — it works",
  CHECK_REJECTS_ROOT: "Check it in the original — it fails",
  // --- Integrals (integral.ts) ---
  SPLIT_TERMS: "Integrate each term separately",
  POWER_RULE: "Raise the power by one, divide by it",
  CONSTANT_RULE: "A constant integrates to constant times x",
  STANDARD_INTEGRAL: "A standard integral",
  COMBINE_TERMS: "Put the pieces back together",
  ADD_CONSTANT: "Add the constant of integration",
  FUNDAMENTAL_THEOREM: "Evaluate between the bounds",
  EVALUATE_UPPER: "Substitute the upper bound",
  EVALUATE_LOWER: "Substitute the lower bound",
  SUBTRACT_BOUNDS: "Subtract lower from upper",
  // --- Percentages + ratios (percent.ts) ---
  PERCENT_MEANS: "A percent is out of 100",
  WRITE_PRODUCT: "Write it as a multiplication",
  WRITE_FRACTION: "Write it as a fraction of the whole",
  TIMES_100: "Multiply by 100 to get the percent",
  FIND_PART: "Work out the percentage part",
  ADD_PART: "Add the part on",
  SUBTRACT_PART: "Take the part off",
  TOTAL_PARTS: "Count the total parts",
  ONE_PART: "Find what one part is worth",
  EACH_SHARE: "Work out each share",
  FIND_GCD: "Find the biggest common factor",
  DIVIDE_ALL_PARTS: "Divide every part by it",
  WRITE_AS_FRACTIONS: "A ratio is a fraction",
  DIVIDE_BOTH_SIDES: "Divide both sides",
  // --- Atomic Step Engine (atomize.ts) ---
  FIND_FACTOR_PAIR: "Find the pair of numbers",
  SPLIT_MIDDLE_TERM: "Split the middle term",
  WRITE_FACTORS: "Write it as two factors",
  ZERO_PRODUCT: "Separate into possible cases",
  RULE_PRODUCT: "Spot the product rule",
  RULE_QUOTIENT: "Spot the quotient rule",
  RULE_CHAIN: "Spot the chain rule",
  DIFFERENTIATE_PARTS: "Differentiate each piece",
  APPLY_RULE: "Put the rule together",
  COMMON_DENOMINATOR: "Find the common denominator",
  REWRITE_EQUIVALENT: "Rewrite over that denominator",
  COMBINE_NUMERATORS: "Put it over one denominator",
  ADD_NUMERATORS: "Combine the numerators",
  MULTIPLY_BY_RECIPROCAL: "Flip the second fraction and multiply",
  MULTIPLY_FRACTIONS: "Multiply across top and bottom",
  MULTIPLY_OUT: "Work out the top and bottom",
  ALIGN_DECIMALS: "Line up the decimal points",
  SCALE_TO_WHOLE: "Scale up to whole numbers",
  COMPUTE_WHOLE: "Do the whole-number arithmetic",
  ADD_VALUES: "Add up the values",
  DIVIDE_BY_COUNT: "Divide by how many there are",
  SORT_DATA: "Put the data in order",
  PICK_MIDDLE: "Take the middle",
  FIND_EXTREMES: "Find the largest and smallest",
  SUBTRACT_EXTREMES: "Subtract the smallest from the largest",
  DEVIATIONS: "How far each value is from the mean",
  SQUARE_DEVIATIONS: "Square each difference",
  SUM_SQUARES: "Add the squares up",
  SQUARE_ROOT: "Take the square root",
  SECOND_MATRIX: "The second matrix",
  ENTRY_ROW_BY_COLUMN: "Row times column",
  COMBINE_ENTRY: "Do it entry by entry",
  CROSS_MULTIPLY: "Cross-multiply the diagonals",
  MINOR: "Work out the minor",
  COFACTOR_EXPANSION: "Expand along the first row",
  SUM_DIAGONAL: "Add the diagonal",
  ADJUGATE: "Swap the diagonal, flip the signs",
  DIVIDE_BY_DET: "Divide every entry by the determinant",
  BRACKETS_FIRST: "Brackets first",
  INDICES: "Then the powers",
  MULTIPLY_DIVIDE: "Then multiply and divide",
  ADD_SUBTRACT: "Add and subtract last",
